# Contributing to KaziRayhan/jwt

First off, thanks for taking the time to contribute!

## Reporting issues

We accept bug and feature requests via issues created [here](https://github.com/KaziRayhan/jwt/issues).
...
- **Always try the [master](https://github.com/KaziRayhan/jwt) branch** - to see if the reported bug has not already been fixed.

## Pull Requests

We accept contributions via pull requests [here](https://github.com/KaziRayhan/jwt/pulls).
